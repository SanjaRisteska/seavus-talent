...
import com.seavus.dataaccess.LoanPostgreHibernateRepository;
...
public class Library {
	...
	public static void main(String[] args) throws IOException {
		...
		LibraryController libraryController = new LibraryController(
				new LibraryService(new PublicationPostgreHibernateRepository(sessionFactory),
						new MembershipPostgreHibernateRepository(sessionFactory),
						new LoanPostgreHibernateRepository(sessionFactory)));
